...
frm.addEventListener("submit", (e) => {
    ...
    //dispara um evento de click em btListar (equivale um clique no botão da pagina)
...
frm.btListar.addEventListener("click", () => {
    ...
    //metodo reduce() concatena uma string, obtendo modelo e preço de cada veiculos
